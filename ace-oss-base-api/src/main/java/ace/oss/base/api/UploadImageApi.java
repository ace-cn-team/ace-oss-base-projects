...
@FeignClient(
        ...
        contextId = "UploadImageApi",
        path = "/" + UploadImageApi.MODULE_RESTFUL_NAME,
...
public interface UploadImageApi {
    ...
    @RequestMapping(path = "/upload/image", method = RequestMethod.POST, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
